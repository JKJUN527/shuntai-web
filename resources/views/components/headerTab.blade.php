        ...
        <div class="col-sm-9 logo_right">
            ...
            <div class="top-menu">
                <ul>
                    ...
                    <li><a href="#" class="btn btn-default btn-default_2 pull-left uls-trigger" data-toggle="modal" data-target="#">中文版</a></li>
                    <li><a href="#" class="btn btn-default btn-default_2 pull-left uls-trigger" data-toggle="modal" data-target="#applyModal_2">英文版</a></li>
                </ul>
            </div>
